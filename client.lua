...
Citizen.CreateThread(function()
    ...
    if car ~= 0 and (InVehicle or IsCar(car)) then
      ...
      if SeatbeltON then 
        DisableControlAction(0, 75, true)  -- Verbiete Aussteigen, wenn angeschnallt
        DisableControlAction(27, 75, true) -- Verbiete Aussteigen während der Fahrt, wenn angeschnallt
	    end
